        ...
        <div class="w-full overflow-hidden ">
            <div class="w-full overflow-x-auto">
                <div class="my-4 flex justify-end space-x-2">
                    <button onclick="exportToPDF('empresas_receptoras')"
                        class="inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <button onclick="exportarXLSX('empresas_receptoras')"
                        class="inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-green-600 hover:bg-green-700 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        @if (count($receptoras) > 0)
                            @foreach ($receptoras as $receptora)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td>
                                        <a class="flex justify-center exclude-column" href="{{route('receptora.eliminar',$receptora->id)}}">
