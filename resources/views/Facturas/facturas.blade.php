                        ...
                        @if (count($facturas) > 0)
                            @foreach ($facturas as $factura)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm exclude-column">
                                    ...
                                    <td class="px-4 py-3 text-sm text-center flex justify-center exclude-column">
                                        <a class="flex justify-center"
                                    ...
                                    <td>
                                        <a class="flex justify-center exclude-column" href="{{ route('factura.eliminar', $factura->id) }}">
