        ...
        <div class="w-full overflow-hidden ">
            <div class="w-full overflow-x-auto">
                <div class="my-4 flex justify-end space-x-2">
                    <button onclick="exportToPDF('empresas_emisoras')"
                    ...
                    <button onclick="exportarXLSX('empresas_emisoras')"
                        ...
                        @if (count($emisoras) > 0)
                            @foreach ($emisoras as $emisora)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td>
                                        <a class="flex justify-center exclude-column" href="{{route('emisora.eliminar',$emisora->id)}}">
